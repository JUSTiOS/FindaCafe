...
class KakaoMapCoordinator: NSObject, MapControllerDelegate, ObservableObject {
    ...
    func createLabelLayer() {
        ...
        let layerOption = LabelLayerOptions(layerID: "PoiLayer", competitionType: .none, competitionUnit: .symbolFirst, orderType: .rank, zOrder: 1000000)
    ...
    func moveCamera() {
        ...
        mapView.animateCamera(cameraUpdate: cameraUpdate, options: CameraAnimationOptions(autoElevation: true, consecutive: false, durationInMillis: 600))
    }
